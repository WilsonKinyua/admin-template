					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="all_stock.php">Sales</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">RefID:</label>
										</div>
									</div>
									...
									<div class="col-lg-12 p-t-20 text-center">
										<button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default">Cancel
										</button>

										<button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Submit
										</button>
									</div>
								</div>
							</div>
