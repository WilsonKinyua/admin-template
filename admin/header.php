				...
				<div class="top-menu">
					<ul class="nav navbar-nav pull-right">
									...
									<ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
										...
										<li>
											<a href="#">
												...
												<span class="message"> <i class="fa fa-check fa-xs"></i><i class="fa fa-check  fa-xs"></i>  Looking for a new Subaru </span>
											</a>
										</li> 
									</ul>
									<div class="dropdown-menu-footer">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								data-close-others="true">
								<img alt="" class="img-circle " src="../assets/img/dp.jfif" />
								<span class="username username-hide-on-mobile"> Patrick </span>
