					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">Sales</a>&nbsp;<i
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="add_record.php" id="addRow"
																		class="btn btn-info">
														...
														<div class="table-scrollable">
															<table
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		<td >
																			<img src="https://direct.co.ke/assets/images/car-ranking/car-ranking-3.jpg"
																				alt="" class="img img-responsive" style="border-radius: 3px; ">
																		</td>
																		<td>Toyota RAV 4</td>
																		<td>3.45 M</td>
																		<td>3.6 M</td>
																		<td>Salim Yusuf</td> 
																		<td class="center">12 Jan 2022</td>
																		<td>
																			...
																			<a href="javascript:void(0)" class=""
																				data-bs-toggle="tooltip" title="View Invoice"><i
																					class="fa  fa-bookmark-o"></i></a>
																		</td>
																	</tr>
																	<tr class="odd gradeX">
																		<td >
																			<img src="https://direct.co.ke/assets/images/car-ranking/car-ranking-2.jpg"
																				alt="" class="img img-responsive" style="border-radius: 3px; ">
																		</td>
																		<td>Subaru X3</td>
																		<td>7.2 M</td>
																		<td>7.5 M</td>
																		<td>Jared Manu</td> 
																		<td class="center">22 Dec 2021</td>
																		<td>
																			<a href="javascript:void(0)" class="text-inverse"
																				title="Record Payment" data-bs-toggle="tooltip">
																				<i class="fa fa-edit"></i></a> 
