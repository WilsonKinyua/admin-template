					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">Stock</a>&nbsp;<i
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="add_stock.php" id="addRow"
																		class="btn btn-info">
														...
														<div class="table-scrollable">
															<table
																...
																<tbody>
																	...
																	<tr class="odd gradeX">
																		<td >
																			<img src="https://direct.co.ke/assets/images/car-details/car-details-5.jpg"
