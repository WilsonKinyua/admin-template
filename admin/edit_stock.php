				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Manage Stock</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="all_stock.php">Inventory</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<label class="control-label col-md-3">UPLOAD PRODUCT PHOTOS:
										</label>
										<div class="col-md-12">
									...
									<div class="col-lg-4 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Branc Name:</label>
										</div>
									</div>
									<div class="col-lg-4 p-t-20">
										<div
									...
									<div class="col-lg-4 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtCourseCode">
											<label class="mdl-textfield__label"><strong> Price in Shillings:</strong></label>
										</div>
									</div>
									<div class="col-lg-4 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtCourseCode">
											<label class="mdl-textfield__label">How many are in store:</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" rows="4" id="text7"></textarea>
											<label class="mdl-textfield__label" for="text7">Description  or any other details:</label>
										</div>
									</div>   
